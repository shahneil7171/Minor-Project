...
<div class="profile-content-card">
    ...
    <div class="card-body">
        <form action="{{ route('profile.addresses.store') }}" method="POST" class="needs-validation">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('additional_info') is-invalid @enderror" id="additional_info" name="additional_info" rows="3" placeholder="e.g., Gate number, building name, etc.">{{ old('additional_info') }}</textarea>
            ...
            <div class="default-address-options">
                ...
                <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" id="is_default_shipping" name="is_default_shipping" value="1" {{ old('is_default_shipping') ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_default_shipping">
                        <i class="fas fa-truck text-info"></i> Default Shipping Address
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_default_billing" name="is_default_billing" value="1" {{ old('is_default_billing') ? 'checked' : '' }}>
