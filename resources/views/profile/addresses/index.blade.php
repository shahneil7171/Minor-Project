            ...
            <div class="address-card">
                <div class="address-card-header">
                    ...
                    <div class="address-actions">
                        <a href="{{ route('profile.addresses.edit', $address) }}" class="btn btn-sm btn-outline-primary" title="Edit">
                ...
                <div class="address-card-body">
                    ...
                    <p class="address-text mb-0">
                        ...
                        <span class="ms-4">{{ $address->city }}, {{ $address->state }} - {{ $address->pincode }}</span><br>
                        <span class="ms-4">{{ $address->country }}</span>
                    </p>

                    @if($address->additional_info)
                        <p class="address-text text-muted small mt-2 mb-0">
                            <i class="fas fa-sticky-note text-muted"></i> {{ $address->additional_info }}
                        </p>
                    @endif
                </div>
                ...
                <div class="address-card-footer">
                    <div class="default-badges">
                        ...
                        @else
                            <form action="{{ route('profile.addresses.set-default-shipping', $address) }}" method="POST" style="display: inline;">
                                @csrf
                        ...
                        @else
                            <form action="{{ route('profile.addresses.set-default-billing', $address) }}" method="POST" style="display: inline;">
                                @csrf
