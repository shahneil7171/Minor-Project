...
@section('body')
    ...
    <h1 style="{{ $heading }}">Your returned product has been received</h1>

    <p style="{{ $text }}">
        Hello {{ $buyerName }}, your returned product for order
        <strong>#{{ $returnRequest->order_number }}</strong> has been received.
    </p>
    ...
    <p style="{{ $text }} margin-top:16px;">
        ...
        You will be notified when your refund starts processing.
    </p>
