    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="field" style="grid-column:1 / -1;">
                    <p style="margin:0 0 12px; color:#94a3b8; font-size:0.9rem; line-height:1.6;">Optional. Add options such as <strong>Size</strong>, <strong>Color</strong>, <strong>Storage</strong>, <strong>RAM</strong>, <strong>Material</strong> etc., then click <strong>Generate variants</strong> to set a price, stock and SKU for every combination. Leave this empty for a simple product with no options.</p>
