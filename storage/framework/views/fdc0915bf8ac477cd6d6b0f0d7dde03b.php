                ...
                <header class="navbar">
                    ...
                    <div class="nav-actions">
                        <?php if(Route::has('login')): ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-dark">Login</a>
                    ...
                    <div class="hero-card">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div style="margin-bottom: 12px; padding: 10px 12px; border-radius: 12px; background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.16); color: #eff6ff;">
                                <strong>Welcome back, <?php echo e(Auth::user()->name); ?>!</strong>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="hero-actions">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-dark">Create account</a>
                        </div>
                        <div class="mini-grid">
                            <div class="mini-card">
...
<?php /**PATH C:\Minor Project\Minor-Project\OpensourceE-commercewebsite\resources\views/welcome.blade.php ENDPATH**/ ?>