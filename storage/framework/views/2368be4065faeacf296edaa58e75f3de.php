    ...
    <div class="panel">
        <div class="topbar">
            <div>
                ...
                <h1 style="margin: 10px 0 6px; font-size: 1.8rem;">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
            ...
            <div style="display: flex; align-items: center; gap: 16px;">
                ...
                <a href="<?php echo e(route('profile.show')); ?>" style="display: flex; align-items: center; gap: 8px; padding: 8px 12px; border-radius: 999px; background: rgba(102,126,234,0.2); color: #bfdbfe; text-decoration: none; font-weight: 600; border: 1px solid rgba(102,126,234,0.4);">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <h3><?php echo e(Auth::user()->phone ? 'Complete' : 'Incomplete'); ?></h3>
                <div style="color:#cbd5e1;">
                    <?php if(Auth::user()->phone): ?>
                        All details updated
                    <?php else: ?>
                        <a href="<?php echo e(route('profile.edit')); ?>" style="color: #60a5fa; text-decoration: none;">Add phone number</a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="stat-card">
                <div class="pill">Addresses</div>
                <h3><?php echo e(Auth::user()->addresses()->count()); ?></h3>
                <div style="color:#cbd5e1;">
                    <a href="<?php echo e(route('profile.addresses.index')); ?>" style="color: #60a5fa; text-decoration: none;">View all</a>
                </div>
            </div>
        </div>
        ...
        <div class="content-grid">
            <div class="card">
                ...
                <div class="list">
                    <div class="list-item">
                        <strong>Name:</strong> 
                        <span style="float: right;"><?php echo e(Auth::user()->name); ?></span>
                    </div>
                    <div class="list-item">
                        <strong>Email:</strong> 
                        <span style="float: right; font-size: 0.9rem;"><?php echo e(Auth::user()->email); ?></span>
                    </div>
                    <?php if(Auth::user()->phone): ?>
                        <div class="list-item">
                            <strong>Phone:</strong> 
                            <span style="float: right;"><?php echo e(Auth::user()->phone); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="list-item">
                        <strong>Member since:</strong> 
                        <span style="float: right;"><?php echo e(Auth::user()->created_at->format('M d, Y')); ?></span>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="list">
                    <a href="<?php echo e(route('profile.show')); ?>" class="list-item" style="text-decoration: none; color: #e2e8f0; cursor: pointer;">
                    ...
                    <a href="<?php echo e(route('profile.addresses.index')); ?>" class="list-item" style="text-decoration: none; color: #e2e8f0; cursor: pointer;">
                    ...
                    <a href="<?php echo e(route('profile.change-password')); ?>" class="list-item" style="text-decoration: none; color: #e2e8f0; cursor: pointer;">
        ...
        <div class="link-row">
            <a href="<?php echo e(route('products')); ?>">Shop products</a>
            <a href="<?php echo e(route('profile.show')); ?>">My profile</a>
            <a href="<?php echo e(route('profile.addresses.index')); ?>">Saved addresses</a>
        </div>

        <div class="actions">
            <a href="<?php echo e(route('products')); ?>" class="btn btn-primary">Browse products</a>
            <a href="<?php echo e(route('profile.show')); ?>" class="btn btn-primary">My Account</a>
...
<?php /**PATH C:\Minor Project\Minor-Project\OpensourceE-commercewebsite\resources\views/dashboard.blade.php ENDPATH**/ ?>